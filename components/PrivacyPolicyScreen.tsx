    ...
    <div className="fixed inset-0 bg-gray-100 dark:bg-gray-900 z-50 flex flex-col">
      ...
      <main className="flex-grow overflow-y-auto p-4 sm:p-6">
        <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 text-gray-700 dark:text-gray-300">
          ...
          <p className="font-semibold mb-2">Fecha de vigencia: [21/06/2025]</p>
          <p className="mb-6">
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc list-inside space-y-1 pl-4">
              ...
              <li>Datos de interacción con el chatbot (texto y voz convertida a texto).</li>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li>Las imágenes faciales se procesan en tiempo real y no se almacenan en servidores de nuestra aplicación.</li>
              <li>Los datos de interacción pueden ser usados para mejorar el modelo conversacional de manera anonimizada.</li>
            </ul>
          </section>

          <section className="mb-6">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">4. Compartición y divulgación de la información</h2>
            <p>
              Para proporcionar las funcionalidades centrales de análisis facial y el chatbot inteligente, nuestra aplicación utiliza la tecnología de inteligencia artificial de Google (Google Gemini). Esto implica que las fotografías faciales capturadas temporalmente y el texto de sus interacciones con el chatbot son enviados a la API de Google Gemini para su procesamiento y análisis.
            </p>
            <p className="mb-1">
              Google procesa esta información de acuerdo con su propia política de privacidad. Para más detalles sobre cómo Google gestiona la privacidad de los datos en sus servicios de IA, por favor consulta la política de privacidad de Google:
              {' '}
              <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline dark:text-primary dark:hover:underline">
                Política de Privacidad de Google
              </a>
            </p>
            <p className="mb-1">
              Aparte de lo mencionado anteriormente con respecto a los servicios de Google, no compartimos su información personal con otros terceros sin su consentimiento explícito, a menos que sea requerido por ley.
            </p>
          </section>

          <section className="mb-6">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">5. Seguridad de los datos</h2>
            <ul className="list-disc list-inside space-y-1 pl-4">
          ...
          <section className="mb-6">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">6. Tus derechos</h2>
            <ul className="list-disc list-inside space-y-1 pl-4">
          ...
          <section className="mb-6">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">7. Contacto</h2>
            <p className="mb-1">
